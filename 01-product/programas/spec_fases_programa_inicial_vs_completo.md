...
- **family_id / ruta**: unidad de producto/UX que agrupa programas relacionados (precuela + completo).
...
Para algunas rutas (por ejemplo "Recomposición total"), queremos que el usuario viva la experiencia como una continuidad:

- La **Fase inicial (gratis)** es una **introducción** de 4 semanas.
- El **Programa completo (premium)** es la **continuación** con 12 semanas divididas en 3 fases (Fase 1–3).
...
- Evitar repetición (no mostrar Fase 1/2/3 bloqueadas con el mismo mensaje).
...
> "Programa completo" > "Fase avanzada" por claridad.
