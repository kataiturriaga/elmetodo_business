...
|----------|-------|-------|----------|
| Screen views (route observer) | 48 | 48 | 100% |
| Screen views (navbar tabs) | 4 | 4 | 100% |
| Custom events | 78 | 101 | 77% |
...
| | **APP LIFECYCLE** | | | | |
| 95 | `app_open` | Lifecycle | **Wired** | — | `app_startup_provider.dart` — _initializePostAuth() |

**Summary by status**:
- **Wired** (sending data in production): 78 events
